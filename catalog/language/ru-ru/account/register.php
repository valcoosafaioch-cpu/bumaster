...
$_['text_telephone_hint']  = 'Телефон нужен для связи по заказу и уведомлений о доставке.';
$_['text_country_russia']  = 'Россия (+7)';
$_['text_country_kazakhstan'] = 'Казахстан (+7)';
$_['text_country_belarus'] = 'Беларусь (+375)';
...
$_['entry_telephone_code'] = 'Код страны';
$_['entry_telephone_number'] = 'Телефон';
...
$_['error_agree'] = 'Вы должны ознакомиться и согласиться с %s!';
$_['error_email_exists_confirmed'] = 'Этот email уже зарегистрирован. Вы можете <a href="%s">войти</a> или <a href="%s">восстановить пароль</a>.';
$_['error_telephone_russia'] = 'Укажите 10 цифр номера после кода +7!';
$_['error_telephone_other'] = 'Укажите номер телефона, используя только цифры!';
