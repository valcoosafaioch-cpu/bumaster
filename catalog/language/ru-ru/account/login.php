...
$_['text_confirm_email_message'] = 'Ваш email ещё не подтверждён. Нажмите кнопку ниже для подтверждения.';
...
$_['error_email_not_confirmed']    = 'Аккаунт существует, но email ещё не подтверждён.';
