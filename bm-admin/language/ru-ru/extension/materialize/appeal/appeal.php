<?php
// Modal
$_['modal_title']					= 'Спасибо, что установили %s!';
$_['modal_alert']					= '<p>Привет! Спасибо, что установили %s! Если вам понравится эта работа, пожалуйста, поддержите развитие проекта. Оставьте пожалуйста отзыв или сделайте пожертвование.</p> <p>Приятного использования!</p> <p>С Уважением, <a href="//goo.gl/whkvt3" target="_blank" rel="noopener">Антон</a>.</p>';
$_['modal_review']					= 'Оставьте отзыв';
