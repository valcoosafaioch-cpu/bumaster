<?php
// Modal
$_['modal_title']					= 'Vă mulțumim pentru instalarea %s!';
$_['modal_alert']					= '<p>Buna!</p> <p>Vă mulțumim pentru instalarea %s! Dacă vă bucurați de această lucrare, vă rugăm să sprijiniți dezvoltarea proiectului. Lăsați un feedback sau faceți o donație.</p> <p>Folosire plăcută!</p> <p>Cu respect, <a href="//goo.gl/whkvt3" target="_blank" rel="noopener">Anton</a>.<p>';
$_['modal_review']					= 'Lasă o recenzie';
$_['modal_donations_title']			= 'Donații';
$_['modal_donations_text']			= 'Vă rugăm să sprijiniți dezvoltarea șablonului cu ajutorul donațiilor.';
